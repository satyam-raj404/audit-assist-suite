...
def main(tracker_path, ppt_path, output_folder_path):
    ...
    for _, review_row in issue_tracker_raw_df.iterrows():
        ...
        cell_configs = [
            {"name": "risk", "cell": shapes_with_tables[1].table.rows[1].cells[0], "max_lines": 4},
            {"name": "csc", "cell": shapes_with_tables[1].table.rows[3].cells[0], "max_lines": 4},
            {"name": "id", "cell": shapes_with_tables[1].table.rows[6].cells[0], "max_lines": 4},
            {"name": "rec", "cell": shapes_with_tables[1].table.rows[8].cells[0], "max_lines": 5},
            {"name": "mr", "cell": shapes_with_tables[1].table.rows[2].cells[1], "max_lines": 18},
            {"name": "resp", "cell": shapes_with_tables[1].table.rows[8].cells[1], "max_lines": 5}
        ]
