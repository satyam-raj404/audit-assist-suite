...
class AuditRun(Base):
    ...
    utility_type = Column(String(50), nullable=True)
    report_type = Column(String(20), nullable=True)
    excel_file_id = Column(UUID(as_uuid=True), nullable=True)
    pptx_file_id = Column(UUID(as_uuid=True), nullable=True)
...
class ReconciliationRun(Base):
    ...
    target_file_id = Column(UUID(as_uuid=True), nullable=True)
